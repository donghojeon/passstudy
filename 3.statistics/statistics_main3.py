import os
from statistics_functions3 import process_pickle_file, save_to_excel, aggregate_folder_statistics
...
#    target_folders = [
#        'TLD/EDU', 'TLD/GOV', 'TLD/INT', 'TLD/MIL',
#        'AFRICA', 'ASIA', 'N_AMERICA', 'OCEANIA'
#    ]
